...
class SRSDDataFrameGenerator:
    ...
    def _define_equations(self) -> dict:
        ...
        equations["I_12_1"] = {
            ...
            "variables": ["mu", "N"],
            "sampling": {
                "mu": ("uniform", 1, 5),               # U_log(10^-2, 10^0)
                "N": ("uniform", 1, 5)                 # U_log(10^-2, 10^0)
            },
        ...
        equations["I_12_4"] = {
            ...
            "variables": ["q", "r"],
            "sampling": {
                "q": ("uniform", 1, 5),                # U_log(10^-1, 10^1)
                "r": ("uniform", 1, 5)                 # U_log(10^-1, 10^1)
            },
        ...
        equations["I_14_3"] = {
            ...
            "variables": ["m", "h"],
            "sampling": {
                "m": ("uniform", 1, 5),                # U_log(10^-2, 10^0)
                "h": ("uniform", 1, 5)                 # U_log(10^-2, 10^0)
            },
        ...
        equations["I_14_4"] = {
            ...
            "variables": ["k", "x"],
            "sampling": {
                "k": ("uniform", 1, 5),                # U_log(10^2, 10^4)
                "x": ("uniform", 1, 5)                 # U_log(10^-2, 10^0)
            },
        ...
        equations["I_8_14"] = {
            ...
            "sampling": {
                "x1": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "x2": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "y1": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "y2": ("uniform", 1, 5)                # U_log(10^-1, 10^1)
            },
        ...
        equations["I_10_7"] = {
            ...
            "variables": ["m0", "v"],
            "sampling": {
                "m0": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "v": ("uniform", 1, 2)                # U_log(10^5, 10^8)
            },
        ...
        equations["I_11_19"] = {
            ...
            "sampling": {
                "x1": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "x2": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "x3": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "y1": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "y2": ("uniform", 1, 5),               # U_log(10^-1, 10^1)
                "y3": ("uniform", 1, 5)               # U_log(10^-1, 10^1)
            },
        ...
        equations["I_12_2"] = {
            ...
            "variables": ["q1", "q2", "r"],
            "sampling": {
                "q1": ("uniform", 1, 5) ,               # U_log(10^-1, 10^1)
                "q2": ("uniform", 1, 5) ,               # U_log(10^-1, 10^1)
                "r": ("uniform", 1, 5)                  # U_log(10^-1, 10^1)
            },
        ...
        equations["I_12_11"] = {
            ...
            "sampling": {
                "q": ("uniform", 1, 5) ,                # U_log(10^-1, 10^1)
                "E": ("uniform", 1, 5) ,                # U_log(10^-1, 10^1)
                "B": ("uniform", 1, 5) ,                # U_log(10^-1, 10^1)
                "v": ("uniform", 1, 5) ,                # U_log(10^-1, 10^1)
                "theta": ("uniform", 1, 5)             # U(0, pi/2)
            },
        ...
        equations["B2"] = {
            ...
            "sampling": {
                "m": ("uniform", 1, 3),               # U_log(10^23, 10^25)
                "k_G": ("uniform", 1, 3),              # U_log(10^9, 10^11)
                "L": ("uniform", 1, 3),                # U_log(10^8, 10^10)
                "E": ("uniform", 1, 3),               # U_log(10^25, 10^27)
                "theta1": ("uniform", 0, 6),          # U(0, 2π)
                "theta2": ("uniform", 0, 6)           # U(0, 2π)
            },
        ...
        equations["B3"] = {
            ...
            "sampling": {
                "d": ("uniform", 1, 3),                # U_log(10^8, 10^10)
                "alpha": ("uniform", 2, 4),                 # U(0,1)
                "theta1": ("uniform", 4, 5),          # U(0, 2π)
                "theta2": ("uniform", 4, 5)           # U(0, 2π)
            },
        ...
        equations["B4"] = {
            ...
            "sampling": {
                "m": ("uniform", 1, 3),               # U_log(10^23, 10^25)
                "E": ("uniform", 8, 12),               # U_log(10^25, 10^27)
                "U": ("uniform", 1, 3),               # U_log(10^25, 10^27)
                "L": ("uniform", 1, 3),                # U_log(10^8, 10^10)
                "r": ("uniform", 1, 3)                 # U_log(10^8, 10^10)
            },
        ...
        equations["B5"] = {
            ...
            "sampling": {
                "d": ("uniform", 1, 3),                # U_log(10^8, 10^10)
                "m1": ("uniform", 1, 3),              # U_log(10^23, 10^25)
                "m2": ("uniform", 1, 3)               # U_log(10^23, 10^25)
            },
        ...
        equations["B6"] = {
            ...
            "sampling": {
                "epsilon": ("uniform", 1, 3),       # U_log(10^-18, 10^-16)
                "E": ("uniform", 1, 3),             # U_log(10^-18, 10^-16)
                "L": ("uniform", 1, 3),              # U_log(10^-10, 10^-8)
                "m": ("uniform", 1, 3),             # U_log(10^-30, 10^-28)
                "Z1": ("uniform", 1, 3),                # U_log(10^0, 10^1)
                "Z2": ("uniform", 1, 3),                # U_log(10^0, 10^1)
                "q": ("uniform", 1, 3)               # U_log(10^-14, 10^-6)
            },
    ...
    def generate_single_dataframe(self, equation_key: str, size: int = 10000) -> pd.DataFrame:
        """
    ...
    def generate_all_dataframes(self, size: int = 10000) -> dict[str, pd.DataFrame]:
        """
    ...
    def save_dataframes(self, dataframes: dict[str, pd.DataFrame], output_dir: str = "./srsd_dataframes"):
...
def generate_srsd_dataframes(size: int = 100, save: bool = True) -> dict[str, pd.DataFrame]:
    """
    Function to generate the 15 DataFrames SRSD.
    ...
    """
    generator = SRSDDataFrameGenerator()
...
if __name__ == "__main__":
    dfs = generate_srsd_dataframes(size=1000, save=True)
